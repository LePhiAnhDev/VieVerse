            ...
            include: [
                {
                    model: User,
                    as: 'company',
                    attributes: ['id', 'name', 'company_name', 'avatar', 'is_verified', 'industry']
                },
                {
                    model: User,
                    as: 'selectedStudent',
                    ...
                    include: [
                        {
                            model: User,
                            as: 'student',
                            attributes: ['id', 'name', 'avatar', 'university', 'major', 'skills']
                        }
                    ]
                }
            ]
        ...
        const tasks = await Task.findAndCountAll({
            ...
            include: [
                ...
                },
                {
                    model: Application,
                    as: 'applications',
                    where: req.user.role === 'student' ? { student_id: req.user.id } : undefined,
                    required: req.user.role === 'student',
                    include: req.user.role === 'company' ? [
                        {
                            model: User,
                            as: 'student',
                            attributes: ['id', 'name', 'avatar', 'university', 'major', 'skills']
