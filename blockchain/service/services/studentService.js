  ...
  async registerStudent(name, skills, address) {
    try {
      ...
      if (Array.isArray(skills)) {
        ...
        throw new ValidationError("Skills must be an array or string");
      }
      const validatedSkills = validateString(skillsString, "skills", 1, 1000);
